...
void stb_radix_7_dit(const cmplx *tw, cmplx *out, int count)
{
    ...
    stb_real_t T21 = STB_KP974927912 * (T12 - T13) - STB_KP781831482 * (T15 - T16) -
                     STB_KP433883739 * (T18 - T19);
    ...
    out[2 * count].real = STB_KP623489801 * (T8 + T9)
                          ...
                          - (STB_KP222520933 * (T2 + T3)
                             + STB_KP900968867 * (T5 + T6))
                          + T21;
    stb_real_t T38 = STB_KP623489801 * (T15 + T16) + T30 -
                     (STB_KP222520933 * (T12 + T13) + STB_KP900968867 * (T18 + T19));
    ...
    out[5 * count].imag = T38
                          - (STB_KP974927912 * (T3 - T2)
                             - STB_KP781831482 * (T9 - T8)
                             - STB_KP433883739 * (T6 - T5));
    stb_real_t T23 = STB_KP433883739 * (T15 - T16) + STB_KP781831482 * (T12 - T13) +
                     STB_KP974927912 * (T18 - T19);
    ...
    out[count].real = STB_KP623489801 * (T2 + T3)
                      ...
                      - (STB_KP222520933 * (T5 + T6)
                         + STB_KP900968867 * (T8 + T9))
                      + T23;
    stb_real_t T36 = STB_KP623489801 * (T12 + T13) + T30 -
                     (STB_KP222520933 * (T18 + T19) + STB_KP900968867 * (T15 + T16));
    ...
    out[6 * count].imag = T36
                          - (STB_KP433883739 * (T9 - T8)
                             + STB_KP781831482 * (T3 - T2)
                             + STB_KP974927912 * (T6 - T5));
    stb_real_t T25 = STB_KP974927912 * (T15 - T16) + STB_KP433883739 * (T12 - T13) -
                     STB_KP781831482 * (T18 - T19);
    stb_real_t T24 = STB_KP623489801 * (T5 + T6) + T1 -
                     (STB_KP900968867 * (T2 + T3) + STB_KP222520933 * (T8 + T9));
    out[4 * count].real = T24 - T25;
    out[3 * count].real = T24 + T25;
    stb_real_t T29 = STB_KP974927912 * (T9 - T8) + STB_KP433883739 * (T3 - T2) -
                     STB_KP781831482 * (T6 - T5);
    stb_real_t T34 = STB_KP623489801 * (T18 + T19) + T30 -
                     (STB_KP900968867 * (T12 + T13) + STB_KP222520933 * (T15 + T16));
    ...
    while (m < count)
    {
        ...
        stb_real_t T45 = STB_KP974927912 * T38_0 - STB_KP781831482 * T41 -
                         STB_KP433883739 * T44;
        ...
        output[2 * count].real = STB_KP623489801 * T34_0
                                 ...
                                 - (STB_KP222520933 * T12_0
                                    + STB_KP900968867 * T23_0)
                                 + T45;
        stb_real_t T60 = STB_KP623489801 * T52 + T53 -
                         (STB_KP222520933 * T50 + STB_KP900968867 * T51);
        output[2 * count].imag = STB_KP974927912 * T54 - STB_KP781831482 * T56 -
                                 STB_KP433883739 * T55 + T60;
        output[5 * count].imag = T60 - (STB_KP974927912 * T54 - STB_KP781831482 * T56 -
                                        STB_KP433883739 * T55);
        stb_real_t T47 = STB_KP433883739 * T41 + STB_KP781831482 * T38_0 +
                         STB_KP974927912 * T44;
        ...
        output[count].real = STB_KP623489801 * T12_0
                             ...
                             - (STB_KP222520933 * T23_0
                                + STB_KP900968867 * T34_0)
                             + T47;
        stb_real_t T58 = STB_KP623489801 * T50 + T53 -
                         (STB_KP222520933 * T51 + STB_KP900968867 * T52);
        output[count].imag = STB_KP433883739 * T56 + STB_KP781831482 * T54 +
                             STB_KP974927912 * T55 + T58;
        output[6 * count].imag = T58 - (STB_KP433883739 * T56 + STB_KP781831482 * T54 +
                                        STB_KP974927912 * T55);
        stb_real_t T49 = STB_KP974927912 * T41 + STB_KP433883739 * T38_0 -
                         STB_KP781831482 * T44;
        ...
        output[3 * count].real = STB_KP623489801 * T23_0
                                 ...
                                 - (STB_KP900968867 * T12_0
                                    + STB_KP222520933 * T34_0)
                                 + T49;
        stb_real_t T62 = STB_KP623489801 * T51 + T53 -
                         (STB_KP900968867 * T50 + STB_KP222520933 * T52);
        output[3 * count].imag = STB_KP974927912 * T56 + STB_KP433883739 * T54 -
                                 STB_KP781831482 * T55 + T62;
...
void stb_radix_7_idit(const cmplx *tw, cmplx *out, int count)
{
    ...
    stb_real_t T25 = STB_KP623489801 * (T16 + T17) + T15 -
                     (STB_KP900968867 * (T22 + T23) + STB_KP222520933 * (T19 + T20));
    ...
    out[4 * count].imag = T25
                          - (STB_KP974927912 * (T8 - T9)
                             + STB_KP433883739 * (T2 - T3)
                             - STB_KP781831482 * (T5 - T6));
    stb_real_t T38 = STB_KP974927912 * (T20 - T19) + STB_KP433883739 * (T23 - T22) -
                     STB_KP781831482 * (T17 - T16);
    ...
    out[3 * count].real = STB_KP623489801 * (T5 + T6)
                          ...
                          - (STB_KP900968867 * (T2 + T3)
                             + STB_KP222520933 * (T8 + T9))
                          + T38;
    stb_real_t T27 = STB_KP623489801 * (T22 + T23) + T15 -
                     (STB_KP222520933 * (T16 + T17) + STB_KP900968867 * (T19 + T20));
    ...
    out[6 * count].imag = T27
                          - (STB_KP433883739 * (T8 - T9)
                             + STB_KP781831482 * (T2 - T3)
                             + STB_KP974927912 * (T5 - T6));
    stb_real_t T36 = STB_KP433883739 * (T20 - T19) + STB_KP781831482 * (T23 - T22) +
                     STB_KP974927912 * (T17 - T16);
    out[6 * count].real = STB_KP623489801 * (T2 + T3)
                          + T1
                          - (STB_KP222520933 * (T5 + T6)
                             + STB_KP900968867 * (T8 + T9))
    ...
    out[count].real = STB_KP623489801 * (T2 + T3)
                      ...
                      - (STB_KP222520933 * (T5 + T6)
                         + STB_KP900968867 * (T8 + T9))
                      + T36;
    stb_real_t T28 = STB_KP974927912 * (T2 - T3) - STB_KP781831482 * (T8 - T9) -
                     STB_KP433883739 * (T5 - T6);
    stb_real_t T29 = STB_KP623489801 * (T19 + T20) + T15 -
                     (STB_KP222520933 * (T22 + T23) + STB_KP900968867 * (T16 + T17));
    out[2 * count].imag = T28 + T29;
    out[5 * count].imag = T29 - T28;
    stb_real_t T34 = STB_KP974927912 * (T23 - T22) - STB_KP781831482 * (T20 - T19) -
                     STB_KP433883739 * (T17 - T16);
    stb_real_t T30 = STB_KP623489801 * (T8 + T9) + T1 -
                     (STB_KP222520933 * (T2 + T3) + STB_KP900968867 * (T5 + T6));
